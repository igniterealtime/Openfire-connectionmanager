...
abstract class SocketReadingMode {
    ...
    */
     ...
     * challenge.
     */
    abstract void clientChallenged();
     ...
     */
    abstract void clientAuthenticated(boolean success);
    ...
    private String geStreamHeader() {
        ...
        sb.append("\" from=\"");
        sb.append(socketReader.serverName);
        sb.append("\" id=\"");
        sb.append(socketReader.session.getStreamID());
        sb.append("\" xml:lang=\"");
