...
public class SocketAcceptThread extends Thread {
    ...
    public SocketAcceptThread(ServerPort serverPort)
            throws IOException {
        ...
        if (useBlockingMode) {
            acceptingMode = new BlockingAcceptingMode(serverPort, bindInterface);
        }
        else {
            acceptingMode = new NonBlockingAcceptingMode(serverPort, bindInterface);
        }
    }
